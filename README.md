...
This branch contains the implementation of TAT in **MuJoCo locomotion environment**.
<p align="center">
...
Download pretrained models released by Janner et al. [here](https://drive.usercontent.google.com/download?id=1wc1m4HLj7btaYDN8ogDIAV9QzgWEckGy&authuser=0), or use the script provided below.
```
...
This appendix is a copy from [Diffuser README](https://github.com/jannerm/diffuser/blob/main/README.md).
