...
class Parser(Tap):
    ...
    def generate_exp_name(self, args):
        ...
        if callable(exp_name):
            ...
            if args.use_tree:
                exp_name_string += f'_tree_lambda{args.tree_lambda}_th{args.one_minus_alpha}_bs{args.batch_size}{"_vanillawarm" if args.vanilla_warm_start else ""}{"_treewarm" if args.tree_warm_start else ""}{f"_warmstep{args.warm_start_step}" if args.vanilla_warm_start or args.tree_warm_start else ""}'
            else:
                exp_name_string += f'_vanilla_bs{args.batch_size}{"_warm" if args.vanilla_warm_start else ""}{f"_warmstep{args.warm_start_step}" if args.vanilla_warm_start or args.tree_warm_start else ""}'  
